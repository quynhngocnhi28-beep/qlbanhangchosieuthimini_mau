            ...
            <div className="header-top-bar">
                <div className="header-top-content">
                    <div className="header-delivery-info">
                        ...
                        <span className="delivery-phone">1234 56789</span>
                    ...
                    <div className="header-logo-container">
                        <div className="phuclong-logo">
                            <img src={logoImg} alt="Logo" className="header-logo-image" onClick={() => navigate('/')} style={{cursor: 'pointer'}} />
                        </div>
                    </div>
                    ...
                    <div className="header-user-actions">
                        ...
                        >
                            {currentUser ? (currentUser.fullname || currentUser.name || currentUser.user) : 'Đăng nhập'}
                        </button>
